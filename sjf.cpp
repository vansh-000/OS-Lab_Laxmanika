...
int main() {
    ...
    while (completedProcesses < numOfProcesses) {
        ...
        processes[currentShortestJobIndex].turnAroundTime = processes[currentShortestJobIndex].completionTime - processes[currentShortestJobIndex].arrivalTime;
        processes[currentShortestJobIndex].waitingTime = processes[currentShortestJobIndex].turnAroundTime - processes[currentShortestJobIndex].burstTime;
